...
import com.barancewicz.recipewebapp.services.ImageService;
...
public class ImageControllerTest {
    ...
    @Test
    public void testGetImageNumberFormatE() throws Exception{
    ...
    @Test
    public void renderImageFileTest() throws Exception {
        //given
        RecipeCommand command = new RecipeCommand();
        command.setId(1L);
